...
public class DrSbaitso {
    ...
    public void start() {
        ...
        Form hi = new Form("Welcome to our secret room");
        ...
        name.setHint("What do u to call u !");
      
        cg.addComponent(name);
        hi.addComponent(BorderLayout.CENTER, cg);
        Toolbar t = new Toolbar();
        hi.setToolBar(t);
        t.addCommandToRightBar(new Command("let's talk") {
            @Override
    ...
    void showSbaitso() {
        ...
        Display.getInstance().callSerially(new Runnable() {
            public void run() {
                String w = "HELLO " + userName +", MY NAME IS UTalent.\n\nI AM HERE TO HELP YOU.\n" +
