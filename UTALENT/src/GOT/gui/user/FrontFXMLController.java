...
import GOT.gui.publication.PublicationController;
import GOT.services.publication.CommentaireService;
import GOT.services.publication.PublicationService;
  ...
  */     
    ...
    private void AddPostAction() throws IOException {
        ...
        else
        {
            ...
            File dest = new File(Paths.get("C:/Users/HP/Downloads/UTALENT/src/resources/" + p.getTypePublication() + "/" + selectedFile.getName()).toString());
    ...
    private void loadAllpublications(List<Publication> Publications)
    {
        for(Publication P: Publications)
        {
            ...
            if(P.getTypePublication().compareTo("img")==0)
            {
                ...
                Image img = new Image("file:/C:/Users/HP/Downloads/UTALENT/src/resources/img/" + P.getSrcPublication(), 700, 400, false, false);
            ...
            {
                String urlmedia = "file:/C:/Users/HP/Downloads/UTALENT/src/resources/video/" + P.getSrcPublication() ;
            ...
            {
                String urlmedia = "file:/C:/Users/HP/Downloads/UTALENT/src/resources/img/audio/" + P.getSrcPublication() ;
                Media m = new Media(urlmedia);
                MediaPlayer mp = new MediaPlayer(m);
                MediaView media = new MediaView();
                media.setMediaPlayer(mp);
    ...
    {           Parent home_page_parent = FXMLLoader.load(getClass().getResource("user.fxml"));
      ...
      @FXML
    private void don(MouseEvent event) throws IOException
    ...
    {          Parent home_page_parent = FXMLLoader.load(getClass().getResource("../reclamation/ajoutReclamation.fxml"));
                Scene home_page_scene = new Scene(home_page_parent);
                Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                app_stage.hide();
                app_stage.setScene(home_page_scene);
