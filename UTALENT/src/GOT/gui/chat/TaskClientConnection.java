...
import GOT.gui.chat.ParticipateController;
import GOT.gui.groupe.DetailController;
...
public  class TaskClientConnection implements Runnable {
    ...
    Socket socket;
    DetailController server;
    // Create data input and output streams
    DataInputStream input;
    DataOutputStream output;

    public TaskClientConnection(Socket socket,DetailController server) {
        this.socket = socket;
        this.server = server;
