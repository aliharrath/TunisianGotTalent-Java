...
public class UserController implements Initializable {
  ...
  @FXML
    private void btnsignup(MouseEvent event) throws MessagingException {
       ...
       UserService us = new UserService();
        ...
        if (us.Authentification(u)) {
            ...
            if (n1.getText().equals("admin")) {
                ...
                Parent home_page_parent = FXMLLoader.load(getClass().getResource("eventAdmin.fxml"));
                ...
                app_stage.show();
                 ...
                 Parent home_page_parent = FXMLLoader.load(getClass().getResource("talentevent.fxml"));
                    Scene home_page_scene = new Scene(home_page_parent);
                    Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                    app_stage.hide(); 
                    app_stage.setScene(home_page_scene);
            ...
            else if(!(us.checkRole(n1.getText())))
            {
                         ...
                         Parent home_page_parent = FXMLLoader.load(getClass().getResource("chasseurevent.fxml"));
                    Scene home_page_scene = new Scene(home_page_parent);
                    Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                    app_stage.hide(); 
                    app_stage.setScene(home_page_scene);
