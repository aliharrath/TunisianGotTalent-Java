...
public class BaseForm extends Form {
    ...
    public void installSidemenu(Resources res) {
         try {
             ...
             getToolbar().addCommandToSideMenu("donations", calendarImage, e ->new AjoutDonation(current).show());
             getToolbar().addCommandToSideMenu("Groups", trendingImage, e -> new HomeForm(theme).show());
