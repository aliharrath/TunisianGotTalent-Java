...
public class EmailAttachmentSender {
    ...
    public static void sendEmailWithAttachments(String toAddress,String subject, String message)
        ...
        String port="587" ;
        final String userName="fathallahmaha29@gmail.com" ;
        final String password="11403416maha";
 ...
 */
    ...
    public static void main(String[] args) {
        ...
        // message info
        String mailTo = "fathallahmaha29@gmail.com";
        String subject = "This is an email from UTALENT's Customer support";
